<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('HotspotId')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->HotspotId), array('view', 'id'=>$data->HotspotId)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('Alturl')); ?>:</b>
	<?php echo CHtml::encode($data->Alturl); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Keep')); ?>:</b>
	<?php echo CHtml::encode($data->Keep); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Devices')); ?>:</b>
	<?php echo CHtml::encode($data->Devices); ?>
	<br />
