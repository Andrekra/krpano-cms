 ...
 * followed by relations of table "controls" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseControls extends BaseModel {
	...
	public function rules() {
		return array(
			array('keybinvert, camrollreset', 'numerical', 'integerOnly'=>true),
			array('mouseaccelerate, mousespeed, mousefriction, mousefovchange, keybaccelerate, keybspeed, keybfriction, keybfovchange, fovspeed, fovfriction, cursorsize, headswing, touchfriction', 'numerical'),
			array('mousetype, movetocursor, touchtype', 'length', 'max'=>6),
			array('keycodesleft, keycodesright, keycodesup, keycodesdown, keycodesin, keycodesout', 'length', 'max'=>255),
	...
	public function relations() {
		return array(
			'projects' => array(self::HAS_MANY, 'Projects', 'control_id'),
		);
	}
