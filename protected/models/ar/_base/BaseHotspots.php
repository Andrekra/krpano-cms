 ...
 * followed by relations of table "hotspots" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseHotspots extends BaseModel {
	...
	public function rules() {
		return array(
			...
			array('name, alturl, devices, scale9grid, ox, oy, width, height, url, onover, onout, onclick, crop, onovercrop, ondowncrop, mask, effect, onhover, ondown, onup, onloaded, altonloaded, style', 'length', 'max'=>255),
			array('keep, capture, children, preload, zoom, distorted', 'length', 'max'=>5),
			array('blendmode, metatype', 'length', 'max'=>10),
			array('edge', 'length', 'max'=>11),
			array('accuracy', 'length', 'max'=>1),
			array('metadata, visible, enabled, meta, effects', 'safe'),
