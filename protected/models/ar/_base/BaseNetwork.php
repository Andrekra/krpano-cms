...
/**
 * This is the model base class for the table "network".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Network".
 *
 * Columns in table "network" available as properties of the model,
 ...
 *
 */
abstract class BaseNetwork extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Network|Networks', $n);
	}
