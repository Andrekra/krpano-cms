...
return array (
  ...
  'CDbConnection failed to open the DB connection.' => 'CDbConnectionはデータベースに接続できませんでした。',
  'CDbConnection failed to open the DB connection: {error}' => 'CDbConnection はデータベースに接続できません。:{error}',
