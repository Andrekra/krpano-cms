...
return array (
  ...
  'Column name must be either a string or an array.' => 'Ім\'я стовпця повинно бути рядком або масивом.',
  ...
  'Event "{class}.{event}" is attached with an invalid handler "{handler}".' => 'Подія "{class}.{event}" прив\'язана невірним обробником "{handler}".',
  ...
  'Last &gt;&gt;' => 'Остання &gt;&gt;',
  'List data must be an array or an object implementing Traversable.' => 'Список повинен бути представлений масивом або об\'єктом, який реалізує інтерфейс Traversable.',
  'List index "{index}" is out of bound.' => 'Індекс списку "{index}" виходить за його межі.',
  'Login Required' => 'Необхідна авторизація',
  'Map data must be an array or an object implementing Traversable.' => 'Карта повинна бути представлена масивом або об\'єктом, який реалізує інтерфейс Traversable.',
  ...
  'Queue data must be an array or an object implementing Traversable.' => 'Запит повинен бути представлений масивом або об\'єктом, який реалізує інтерфейс Traversable.',
  ...
  'Stack data must be an array or an object implementing Traversable.' => 'Стек повинен бути представлени масивом або об\'єктом, який реалізує інтерфейс Traversable.',
  ...
  'The "db" application component must be configured to be a CDbConnection object.' => 'Компонент додатку "db" повинен бути об\'єктом CDbConnection.',
